				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageList?size>0)>
									<img jqimg="${imageList[0].url}" src="${imageList[0].url}" height="400" width="400"/>
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list customAttributeList as attr>
							    <dl>
                                    ...
                                    <dd><a href="javascript:;" >${attr.value}<span title="点击取消选择">&nbsp;</span>
                                    </a></dd>
							...
							<#list specificationList as spec>
							    <dl>
									...
									<#list spec.attributeValue as value>
										<dd>
											<a href="javascript:;"
											   ng-click="selectSpec('${spec.attributeName}','${value}')"
